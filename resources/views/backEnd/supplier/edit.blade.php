...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('admin.supplier.show', $supplier->id)}}" class="btn btn-secondary rounded-pill"><i class="fe-arrow-left"></i> Back</a>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{route('admin.supplier.update', $supplier->id)}}" id="supplierForm">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('bank_routing') is-invalid @enderror"
                                           ...
                                           value="{{old('bank_routing', $supplier->bank_routing)}}"
                                           placeholder="ABCBDDH">
                                    @error('bank_routing')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <a href="{{route('admin.supplier.show', $supplier->id)}}" class="btn btn-secondary me-2">Cancel</a>
