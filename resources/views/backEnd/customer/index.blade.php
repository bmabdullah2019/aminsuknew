                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <form method="post" action="{{route('admin.customers.inactive')}}" class="d-inline"> 
                                    @csrf
                                    ...
                                    @else
                                    <form method="post" action="{{route('admin.customers.active')}}" class="d-inline">
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">        
                                    ...
                                    <a href="{{route('admin.customers.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>

                                    <a href="{{route('admin.customers.profile',['id'=>$value->id])}}" class="btn btn-xs btn-blue waves-effect waves-light"><i class="fe-eye"></i></a>

                                    <form method="post" action="{{route('admin.customers.adminlog')}}" class="d-inline" target="_blank">
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">  
