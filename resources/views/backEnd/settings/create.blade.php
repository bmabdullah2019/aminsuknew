...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.settings.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            <label for="sidebar_banner_category_id" class="form-label">Sidebar Banner Category</label>
                            <select class="form-control @error('sidebar_banner_category_id') is-invalid @enderror"
                                ...
                                @foreach ($bannerCategories as $bannerCategory)
                                    <option value="{{ $bannerCategory->id }}"
                                        @selected((int) old('sidebar_banner_category_id') === (int) $bannerCategory->id)>
                                        {{ $bannerCategory->name }}
                                    </option>
                                @endforeach
                            </select>
