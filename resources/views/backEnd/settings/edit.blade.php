...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('admin.settings.index')}}" class="btn btn-primary rounded-pill">Manage</a>
                </div>
   ...
   <div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="sidebar_banner_category_id" class="d-block">Sidebar Banner Category</label>
                            <select class="form-control @error('sidebar_banner_category_id') is-invalid @enderror"
                                name="sidebar_banner_category_id" id="sidebar_banner_category_id">
                                <option value="">None</option>
                                @foreach ($bannerCategories as $bannerCategory)
                                    <option value="{{ $bannerCategory->id }}"
                                        @selected((int) old('sidebar_banner_category_id', $edit_data->sidebar_banner_category_id) === (int) $bannerCategory->id)>
                                        {{ $bannerCategory->name }}
                                    </option>
                                @endforeach
                            </select>
                            <small class="text-muted">
                                Selected banner category will be shown on category, subcategory and child-category sidebars.
                            </small>
                            @error('sidebar_banner_category_id')
