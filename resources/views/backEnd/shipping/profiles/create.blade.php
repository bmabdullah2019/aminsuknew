...
@section('title', 'Create Shipping Profile')
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title">Create Shipping Profile</h4>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    <div class="card-body">
      <form action="{{ route('admin.shipping.profiles.store') }}" method="POST" class="row" data-parsley-validate>
        @csrf
