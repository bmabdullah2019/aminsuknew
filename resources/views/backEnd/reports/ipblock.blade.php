    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-4">
                        <div class="border rounded p-2">
                            <small class="text-muted d-block">Total Blocked IPs</small>
                ...
                <form action="{{route('admin.customers.ipblock.store')}}" method="POST" class="row mb-3" data-parsley-validate=""  enctype="multipart/form-data">
                    @csrf
                    <div class="col-sm-12">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <form method="post" action="{{route('admin.customers.ipblock.destroy')}}" class="d-inline">        
                                        @csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('admin.customers.ipblock.update')}}" method="POST" class="row mb-3" data-parsley-validate=""  enctype="multipart/form-data">
            @csrf
