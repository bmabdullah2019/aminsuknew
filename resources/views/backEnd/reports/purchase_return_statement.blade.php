...
@section('title', 'Purchase Return Statement')
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      <div class="page-title-box d-flex align-items-center justify-content-between">
        <h4 class="page-title mb-0">Purchase Return Statement</h4>
        <div class="no-print d-flex gap-2">
          ...
          <a class="btn btn-sm btn-outline-secondary"
             href="{{ route('admin.reports.purchase-returns.print', request()->query()) }}"
  ...
  <div class="card no-print mb-3">
    <div class="card-body">
      <form method="GET" action="{{ route('admin.reports.purchase-returns') }}" class="row g-2 align-items-end">
        <div class="col-md-2">
        ...
        <div class="col-md-2">
          ...
          <select class="form-select form-select-sm" name="status">
            <option value="">All</option>
            @foreach(['draft'=>'Draft','approved'=>'Approved','completed'=>'Completed'] as $k=>$v)
