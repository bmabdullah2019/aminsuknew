...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('admin.campaign.index')}}" class="btn btn-primary rounded-pill">Manage</a>
                </div>
   ...
   <div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.campaign.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                    @csrf
                    ...
                    @include('backEnd.campaign.partials.image-field', [
                        'field' => 'banner',
                        'existingName' => 'banner_existing',
                        'label' => 'Banner Image',
                        'column' => 'col-sm-12',
                        'current' => $edit_data->banner,
                    ])
                    <!-- col end -->
                    ...
                    @include('backEnd.campaign.partials.image-field', [
                        'field' => 'image_one',
                        'existingName' => 'image_one_existing',
                        'label' => 'Image One',
                        'current' => $edit_data->image_one,
                    ])
                    @include('backEnd.campaign.partials.image-field', [
                        'field' => 'image_two',
                        'existingName' => 'image_two_existing',
                        'label' => 'Image Two',
                        'current' => $edit_data->image_two,
                    ])
                    @include('backEnd.campaign.partials.image-field', [
                        'field' => 'image_three',
                        'existingName' => 'image_three_existing',
                        'label' => 'Image Three',
                        'current' => $edit_data->image_three,
                    ])
                    <!-- col end -->
                    <div class="col-sm-6 mb-3">
                        ...
                        <button type="button"
                                class="btn btn-sm btn-outline-primary mt-2 campaign-gallery-open"
                                data-mode="multiple"
                                data-list="campaignExistingReviewList">
                            Add from Gallery
                        </button>
                        <div class="campaign-existing-review-list" id="campaignExistingReviewList"></div>
                        <div class="product_img">
                            @foreach($edit_data->images as $image)
                            <img src="{{asset($image->image)}}" class="edit-image border" alt="" />
                            <a href="{{route('admin.campaign.image.destroy',['id'=>$image->id])}}" class="btn btn-xs btn-danger waves-effect waves-light"><i class="mdi mdi-close"></i></a>
                            @endforeach
                        </div>
                    </div>
                    <!-- col end -->
...
@include('backEnd.campaign.partials.gallery-modal', ['campaignGalleryImages' => $campaignGalleryImages])
@endsection
