                        ...
                        <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                            <tbody style="background:#00aef0">
                                <tr style="color:#fff">
                                    ...
                                    <td><strong>৳{{number_format($invoiceSubtotal, 2)}}</strong></td>
                                </tr>
                                <tr style="color:#fff">
                                    <td><strong>Delivery Charge(+)</strong></td>
                                    <td><strong>৳{{number_format($invoiceDeliveryCharge, 2)}}</strong></td>
                                </tr>
                                <tr style="color:#fff">
                                    <td><strong>Discount(-)</strong></td>
                                    <td><strong>৳{{number_format($invoiceDiscount, 2)}}</strong></td>
                                </tr>
